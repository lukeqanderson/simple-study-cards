...
const DeckListItem = ({ name, id, toReviewCount, totalCount, deleteCard }) => {
    return (
        <div className="deck-list-item">
            ...
            <p onClick={() => deleteCard(id - 1)} className="f6 pointer ba b--black dim ph3 pv2 ma0 mb1 dib bg-dark-red black">Delete</p>
        </div>
    );
}
